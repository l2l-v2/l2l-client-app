...
import { ProcessResponseQuery, } from './task-response.model';
import { Page, PaginationModel } from './page.model';
import {TaskQueryEntry} from './task.model';
import {TaskService} from './task.service';


export class TaskDatasource implements  DataSource<TaskQueryEntry> {
  ...
  queryTask(
    ...
    this.taskService.query(pageIndex, pageSize, sortProperty, sortDirection).pipe(
      catchError(() => of([])),
